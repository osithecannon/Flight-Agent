...
# Endpoint URL
default_url = "https://flight-agent-production-a439.up.railway.app/plan"
api_url = st.sidebar.text_input("Agent API Endpoint", value=default_url)
...
# Trigger search via sidebar button or chat input
